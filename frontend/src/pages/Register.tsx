...
export default function Register() {
  ...
  async function submit() {
    ...
    try {
      ...
      setError('Ошибка. Возможно, этот email уже занят.');
    } finally {
      setLoading(false);
    }
  }
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .wrap {
          ...
          background:
            radial-gradient(ellipse at 80% 10%, rgba(184,244,84,0.08) 0%, transparent 55%),
            radial-gradient(ellipse at 20% 90%, rgba(184,244,84,0.05) 0%, transparent 50%),
            #0d1a0f;
      ...
      <div className="wrap">
        ...
        <div className="heading">
          <h1>Начни быть<br /><em>продуктивным.</em></h1>
