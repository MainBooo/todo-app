    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-wrap::before {
          ...
          background: radial-gradient(circle, rgba(99,176,255,0.08) 0%, transparent 70%);
        ...
        .auth-sub a { color: #63ffb0; text-decoration: none; }
      ...
      <div className="auth-wrap">
        <div className="auth-card">
          ...
          <div className="auth-title">Создать<br />аккаунт</div>
          <div className="auth-sub">Уже есть аккаунт? <a href="/login">Войти →</a></div>
